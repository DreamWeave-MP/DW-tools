...
function get_tes3cmd() {
    ...
    echo "6f3248eb04e98db2151143b0918a2e34133bf2c4cc2bed807d755e464f4931b01613f9e87ed1528fdc7077375e977febcf1528f7419f8894d949ac7719985b57  tes3cmd" | sha512sum -c
...
function get_tes3merge() {
    ...
    echo "69b2b2fa7583122a24cd8f206a6ae19dfac0f541a9f46e0593387e579a3023e6 tes3merge-linux.zip" | sha256sum -c
    ...
    echo "c1f544560057f56eea04d35215408571e5262e0e1ee2dd08035932d1a4fd8f8c tes3merge-osx.zip" | sha256sum -c
    ...
    echo "d079d996d3856567ab3ade38d7761d56e31258a513d626ad727d42f03fc19172 tes3merge-win.zip" | sha256sum -c
