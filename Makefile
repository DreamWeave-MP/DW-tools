...
clean:
	rm -fr LICENSE-groundcoverify.md README-* *.zip *.tar.gz groundcoverify/ linux/ macOS/ momw-configurator/ momw-tools-pack-* openmw-validator/ tes3cmd.0.40-PRE-RELEASE-2/ umo/ windows/
